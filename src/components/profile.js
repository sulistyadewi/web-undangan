      ...
      <div className="flex flex-col">
        ...
        <div id="wanita" className="mx-auto">
          ...
          <p className="text-white text-center mt-3 px-14 text-md leading-snug">
            ...
            teringat jelas dalam ingatan Adi. Sayang, tak sempat berbincang saat
            itu, dan waktupun berganti hari, berganti bulan dan berganti tahun,
            tidak ada komunikasi diantara kami, karena memang kami tak tau kabar
            masing-masing dan bisa dibilang belum begitu kenal.
          </p>
          <p className="text-white text-center mt-5 px-14 text-md leading-snug mb-5">
            Jejaring sosial menjadi jalan kami bertemu kembali , ya dari sanalah
            Adi ingat kembali moment beberapa tahun, akhir tahun 2013 menambah
            sederetan moment-moment yang tak dapat dilupakan, untuk pertama
            kalinya Adi memberanikan diri untuk mengunjungi keluarganya dan
            berniat ingin lebih kenal dengan Siti Salamah Azzahra dan keluarga.
          </p>
        </div>
        <div className="flex flex-wrap justify-between">
